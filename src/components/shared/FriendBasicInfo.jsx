...
const FriendBasicInfo = ({ friendInfo }) => {
  return (
    ...
    />
    <div className="bg-white dark:bg-run-night-element min-w-96 min-h-32 w-1/2 gap-5 flex flex-col justify-center items-center dark:text-white text-center p-2 rounded-xl shadow-xl">
